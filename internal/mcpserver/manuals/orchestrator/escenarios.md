...
>
> Ya se puede también **rechazar con motivo**: el motivo vuelve al agente que escribió y se le pide otro intento, hasta 3 rondas. Descartar, en cambio, es final y no explica nada de vuelta — por eso conviene rechazar, no descartar, cuando se espera que el siguiente salga mejor.
